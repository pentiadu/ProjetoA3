...
public class historicoPaciente extends javax.swing.JFrame {
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        try {
            ...
            ResultSet rs = st.executeQuery("SELECT * FROM patient INNER JOIN patientdiag ON patient.patientID = patientdiag.patientID");
            jTable1.setAutoResizeMode(jTable1.AUTO_RESIZE_OFF);
            jTable1.setModel(DbUtils.resultSetToTableModel(rs));
            
}         catch (Exception e) {
                JOptionPane.showMessageDialog(null, "Error: " + e.getMessage()); // Display the specific error message
