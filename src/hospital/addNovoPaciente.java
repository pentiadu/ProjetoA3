 ...
 * @author lucas
 */
public class addNovoPaciente extends javax.swing.JFrame {

    /**
     * Creates new form adicionarPaciente
     */
    public addNovoPaciente() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Masculino", "Femino" }));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            PreparedStatement preparedStatement = con.prepareStatement("INSERT INTO patient (patientID, name, contactNumber, age, gender, "
                    + "bloodGroup, adress, anyMajorDisease) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
                ...
                JOptionPane.showMessageDialog(null, "Falha ao adicionar o paciente");
    }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(addNovoPaciente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
